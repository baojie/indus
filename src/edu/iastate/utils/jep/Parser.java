...
import edu.iastate.utils.jep.function.Add;
import edu.iastate.utils.jep.function.Comparative;
import edu.iastate.utils.jep.function.Divide;
import edu.iastate.utils.jep.function.Logical;
import edu.iastate.utils.jep.function.Modulus;
import edu.iastate.utils.jep.function.Multiply;
import edu.iastate.utils.jep.function.Not;
import edu.iastate.utils.jep.function.PostfixMathCommandI;
import edu.iastate.utils.jep.function.Power;
import edu.iastate.utils.jep.function.Subtract;
import edu.iastate.utils.jep.function.UMinus;
...
{ /*@bgen(jjtree)*/
        ...
        try
        {
            ...
            if (jep.funTab.containsKey(identString))
            {
                ...
                jjtn001.setFunction(identString,
                                    (PostfixMathCommandI) jep.funTab.get(
                    identString));
            }
            else
            {
    ...
    final private int[] jj_la1_0 =
        ...
        0x600000, 0x3800000, 0x4600000, 0x8000000, 0x400, 0x800002a0,
        0x10000000, 0x40000000, 0x800002a0, 0x40000000, 0xa0, };
    ...
    private void jj_add_error_token(int kind, int pos)
    {
        ...
        else if (jj_endpos != 0)
        {
            ...
            for (java.util.Enumeration enum1 = jj_expentries.elements();
