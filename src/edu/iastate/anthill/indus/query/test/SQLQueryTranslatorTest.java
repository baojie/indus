    ...
    extends SampleBuilder
{
    ...
    public static void testReWriteWhere()
    {
        ...
        ZExpression part1 = ZqlUtils.buildAttributeValuePair(
            "producedAt",
            "<=", "USA", ZConstantEx.AVH);
        ZExpression part2 = ZqlUtils.buildAttributeValuePair("distance",
            "<=", "50", ZConstantEx.NUMBER);
        ZExpression part3 = ZqlUtils.buildAttributeValuePair("soldAt",
    ...
    public static void testTranslateAVHAtomWhere()
    {
        ...
        for (int j = 0; j < location.length; j++)
        {
            ...
            {
                ZExpression q = ZqlUtils.buildAttributeValuePair(
                    "producedAt",
    ...
    public static void testTranslateWhere()
    {
        ...
        test[0] = ZqlUtils.buildAttributeValuePair(
            "soldAt", "=", "producedAt", ZConstantEx.COLUMNNAME);
        test[1] = ZqlUtils.buildAttributeValuePair(
            "id", "=", "1", ZConstantEx.NUMBER);
        test[2] = ZqlUtils.buildAttributeValuePair(
            "name", "=", "iPod", ZConstantEx.STRING);
        test[3] = ZqlUtils.buildAttributeValuePair(
    ...
    public static void testRemoveIn()
    {
        ...
        ZExpression z2 = ZqlUtils.buildAttributeValuePair("soldAt", "<=",
            "Iowa", ZConstantEx.AVH);
