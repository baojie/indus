...
public abstract class MappingPanelAction
    extends MappingPanelGUI implements MessageHandler
{
    ...
    protected String findNodeType(TypedNode node)
    {
        ...
        else // AVH node
        {
            ...
            while (n != null)
            {
                // Debug.trace(this, n + " " + (n instanceof DataSourceNode) + " " + n.getType());
                if ( (n instanceof DataSourceNode) &&
    ...
    {
        DataSourceNode root = new DataSourceNode(schemaName,
                                                 TypedNode.DB,
                                                 "Schema");
    ...
    public void onNewMapping(ActionEvent e)
    {
        ...
        if (s1 != null)
        {
            ...
            String s2 = (String) JOptionPane.showInputDialog(null,
                ...
                data_without_s1.toArray(), data_without_s1.elementAt(0));
            if (s2 != null)
            {
                ...
                if (allMappings != null)
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(this,
                            "Mapping '" + mappingName + "' already exists");
                        return;
                    }
    ...
    public void onAddMapping(ActionEvent e)
    {
        ...
        if (sel instanceof NumericConnector)
        {
            if (n1.getType() == TypedNode.ATTRIBUTE)
            {
                ...
                String supertype1 = IndusHttpClient.
                    getTopSuperType(type1);
                String supertype2 = IndusHttpClient.
                    getTopSuperType(type2);
        ...
        if (n1 != null && n2 != null && conn != null)
        {
            if (n1.getType() == n2.getType())
            {
                ...
                {
                    BridgeRule t = myMapping.addSchemaMappingItem(
                        n1.getUserObject().toString(), conn,
                        n2.getUserObject().toString());
                    t.setComments(SCHEMA_COMMENT);
                    mappingRuleListModel.add(0, t);
                    modified = true;
                }
                else if (n1.getType() == DataSourceNode.AVH) // AVH to AVH mapping
                {
                    ...
                    {
                        BridgeRule t = myMapping.addAVHMappingItem(AVH1,
                            n1.getUserObject().toString(), conn, AVH2,
                            n2.getUserObject().toString());
    ...
    protected boolean save()
    {
        ...
        for (int i = 0; i < num; i++)
        {
            Connector cc = (Connector) mappingConnectorListModel.getElementAt(i);
    ...
    protected void loadMapping(String item)
    {
        ...
        {
            Debug.trace(this,
                        "Mapping '" + item + "' information is not available");
        }
    }
...
// Set the component to show the popup menu
        mappingConnectorsList.addMouseListener(new MouseAdapter()
        {
            ...
            void showMenu(MouseEvent evt)
            {
                ...
                if (evt.isPopupTrigger() && ! (mappingConnectorsList.
                                               getSelectedValue() instanceof
                                               SimpleConnector))
                {
        ...
        while (true)
        {
            ...
            if (dlg.action == JOptionPane.YES_OPTION)
            {
                ...
                else
                {
                    ...
                    mappingConnectorListModel.add(
                        mappingConnectorListModel.getSize(), t);

                    String info = "Connector " + t.name +
