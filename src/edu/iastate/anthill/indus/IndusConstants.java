...
{
    private static String PROJECT_FILE = IndusMain.class.getName().replaceAll(
                                           "\\.", "/")
                                           + ".class";
    ...
    public static final String HOST            = "http://" + DSSERVER + ":"
                                                   + INDUS_PORT + "/wikiont/";
    ...
    public static String        infoAbout         = "<html>"
                                                      + "<font color=\"#FF0099\"><b>"
                                                      + "INDUS Data Integration Environment</b></font><br>Version "
                                                      + VER
                                                      + "<br><br><b>Jie Bao</b><br>"
                                                      + getModifiedTime()
                                                      + "<br>"
    ...
    public static final String  dbURL             = "jdbc:postgresql://"
                                                      + DSSERVER + "/indus";
    public static final String  dbCacheURL        = "jdbc:postgresql://"
                                                      + DSSERVER
                                                      + "/indus-data";
    public static final String  dbLocalURL        = "jdbc:postgresql://"
                                                      + DSSERVER
                                                      + "/indus-local";
